 ...
 *   A form array.
 */
function chicago_2011_settings($saved_settings) {
  // Get the default values from the .info file.
  $subtheme_defaults = omega_theme_get_default_settings('chicago_2011');
  ...
  $form['chicago_2011_container'] = array(
    '#type' => 'fieldset',
    '#title' => t('Chicago 2011 960 settings'),
    '#description' => t('Core configuration options for the Chicago 2011 Omega subtheme.'),
    '#collapsible' => TRUE,
    '#collapsed' => FALSE,
  );
    // General Settings
    $form['chicago_2011_container']['chicago_2011_general'] = array(
      '#type' => 'fieldset',
      '#title' => t('General Chicago 2011 960 Settings'),
      '#description' => t('Configure generic options on rendering content in this theme.'),
      '#collapsible' => TRUE,
      '#collapsed' => TRUE,
    );
    $form['chicago_2011_container']['chicago_2011_general']['optional_css'] = array(
      '#type' => 'fieldset',
      ...
      $form['chicago_2011_container']['chicago_2011_general']['optional_css']['reset_css'] = array(
        '#type'          => 'checkbox',
      ...
      $form['chicago_2011_container']['chicago_2011_general']['optional_css']['text_css'] = array(
        '#type'          => 'checkbox',
      ...
      $form['chicago_2011_container']['chicago_2011_general']['optional_css']['regions_css'] = array(
        '#type'          => 'checkbox',
      ...
      $form['chicago_2011_container']['chicago_2011_general']['optional_css']['defaults_css'] = array(
        '#type'          => 'checkbox',
      ...
      $form['chicago_2011_container']['chicago_2011_general']['optional_css']['custom_css'] = array(
        '#type'          => 'checkbox',
    ...
    // Page titles
      $form['chicago_2011_container']['chicago_2011_general']['page_format_titles'] = array(
        '#type' => 'fieldset',
        '#title' => t('Page titles'),
      ...
      if (module_exists('page_title') == FALSE) {
        // front page title
        $form['chicago_2011_container']['chicago_2011_general']['page_format_titles']['front_page_format_titles'] = array(
          '#type' => 'fieldset',
        ...
        $form['chicago_2011_container']['chicago_2011_general']['page_format_titles']['front_page_format_titles']['front_page_title_display'] = array(
          '#type' => 'select',
        ...
        $form['chicago_2011_container']['chicago_2011_general']['page_format_titles']['front_page_format_titles']['page_title_display_custom'] = array(
          '#type' => 'textfield',
          '#title' => t('Custom'),
          '#size' => 60,
        ...
        // other pages title
        $form['chicago_2011_container']['chicago_2011_general']['page_format_titles']['other_page_format_titles'] = array(
          '#type' => 'fieldset',
          '#title' => t('Other page titles'),
          '#collapsible' => TRUE,
          '#collapsed' => TRUE,
        );
        $form['chicago_2011_container']['chicago_2011_general']['page_format_titles']['other_page_format_titles']['other_page_title_display'] = array(
          '#type' => 'select',
        ...
        $form['chicago_2011_container']['chicago_2011_general']['page_format_titles']['other_page_format_titles']['other_page_title_display_custom'] = array(
          '#type' => 'textfield',
          '#title' => t('Custom'),
          '#size' => 60,
        ...
        $form['chicago_2011_container']['chicago_2011_general']['page_format_titles']['configurable_separator'] = array(
          '#type' => 'textfield',
        ...
        $form['chicago_2011_container']['chicago_2011_general']['page_format_titles']['#description'] = 'NOTICE: You currently have the "Page Title" module installed and enabled, so the Page titles theme settings have been disabled to prevent conflicts.  If you wish to re-enable the Page titles theme settings, you must first disable the "Page Title" module.';
        $form['chicago_2011_container']['chicago_2011_general']['page_format_titles']['configurable_separator']['#disabled'] = 'disabled';
      }

      // Breadcrumb
      $form['chicago_2011_container']['chicago_2011_general']['breadcrumb'] = array(
        '#type'          => 'fieldset',
        '#title'         => t('Breadcrumb settings'),
        '#attributes'    => array('id' => 'chicago-2011-breadcrumb'),
        '#collapsible' => TRUE,
        '#collapsed' => TRUE,
      );
      $form['chicago_2011_container']['chicago_2011_general']['breadcrumb']['chicago_2011_breadcrumb'] = array(
        '#type'          => 'select',
        '#title'         => t('Display breadcrumb'),
        '#default_value' => $saved_settings['chicago_2011_breadcrumb'],
        '#options'       => array(
                              'yes'   => t('Yes'),
      ...
      $form['chicago_2011_container']['chicago_2011_general']['breadcrumb']['chicago_2011_breadcrumb_separator'] = array(
        '#type'          => 'textfield',
        '#title'         => t('Breadcrumb separator'),
        '#description'   => t('Text only. Don’t forget to include spaces.'),
        '#default_value' => $saved_settings['chicago_2011_breadcrumb_separator'],
        '#size'          => 5,
        '#maxlength'     => 10,
      );
      $form['chicago_2011_container']['chicago_2011_general']['breadcrumb']['chicago_2011_breadcrumb_home'] = array(
        '#type'          => 'checkbox',
        '#title'         => t('Show home page link in breadcrumb'),
        '#default_value' => $saved_settings['chicago_2011_breadcrumb_home'],
      );
      $form['chicago_2011_container']['chicago_2011_general']['breadcrumb']['chicago_2011_breadcrumb_trailing'] = array(
        '#type'          => 'checkbox',
        '#title'         => t('Append a separator to the end of the breadcrumb'),
        '#default_value' => $saved_settings['chicago_2011_breadcrumb_trailing'],
        '#description'   => t('Useful when the breadcrumb is placed just before the title.'),
      );
      $form['chicago_2011_container']['chicago_2011_general']['breadcrumb']['chicago_2011_breadcrumb_title'] = array(
        '#type'          => 'checkbox',
        '#title'         => t('Append the content title to the end of the breadcrumb'),
        '#default_value' => $saved_settings['chicago_2011_breadcrumb_title'],
        '#description'   => t('Useful when the breadcrumb is not placed just before the title.'),
      );

      // Mission Statement
      $form['chicago_2011_container']['chicago_2011_general']['mission_statement'] = array(
        '#type' => 'fieldset',
        '#title' => t('Mission statement'),
        '#collapsible' => TRUE,
        '#collapsed' => TRUE,
      );
        $form['chicago_2011_container']['chicago_2011_general']['mission_statement']['mission_statement_pages'] = array(
          '#type'          => 'radios',
    ...
    // Region Settings
    $form['chicago_2011_container']['chicago_2011_regions'] = array(
      '#type' => 'fieldset',
    ...
    $default_chicago_2011_layout = !empty($saved_settings['chicago_2011_fixed_fluid']) ? $saved_settings['chicago_2011_fixed_fluid'] : 'fixed';
      $form['chicago_2011_container']['chicago_2011_regions']['chicago_2011_fixed_fluid'] = array(
          '#type'          => 'radios',
          '#description'   => t('You may select fluid layout, or the default fixed width layout.'),
          '#title'         => t('Fixed / Fluid Layout'),
          '#default_value' => $default_chicago_2011_layout,
          '#options'       => array(
                               'fixed' => t('Fixed width (theme default)'),
                               'fluid' => t('Fluid width'),
                              ),
        );
      $form['chicago_2011_container']['chicago_2011_regions']['chicago_2011_default_container_width'] = array(
        '#type' => 'select',
        '#title' => t('Default container width'),
        '#default_value' => $saved_settings['chicago_2011_default_container_width'],
        '#options' => $containers,
        '#weight' => -50,
      ...
      // Header Blocks
      $form['chicago_2011_container']['chicago_2011_regions']['headers'] = array(
        '#type' => 'fieldset',
        ...
        $form['chicago_2011_container']['chicago_2011_regions']['headers']['chicago_2011_user_bar_wrapper_width'] = array(
          '#type' => 'select',
          '#title' => t('Wrapper Area width for User Bar Elements'),
          '#default_value' => $saved_settings['chicago_2011_user_bar_wrapper_width'],
          '#options' => $containers,
          '#description' => t('Container Grid width for the user bar area and secondary navigation menu.'),
        );
        $form['chicago_2011_container']['chicago_2011_regions']['headers']['chicago_2011_user_bar_first_width'] = array(
          '#type' => 'select',
          '#title' => t('Contextual Width for User Bar First'),
          '#default_value' => $saved_settings['chicago_2011_user_bar_first_width'],
          '#options' => $grids,
        ...
        $form['chicago_2011_container']['chicago_2011_regions']['headers']['chicago_2011_user_bar_last_width'] = array(
          '#type' => 'select',
          '#title' => t('Contextual Width for User Bar Last'),
          '#default_value' => $saved_settings['chicago_2011_user_bar_last_width'],
          '#options' => $grids,
        ...
        $form['chicago_2011_container']['chicago_2011_regions']['headers']['chicago_2011_branding_wrapper_width'] = array(
          '#type' => 'select',
          '#title' => t('Wrapper Area width for Logo/Navigation Elements'),
          '#default_value' => $saved_settings['chicago_2011_branding_wrapper_width'],
          '#options' => $containers,
          '#description' => t('Container Grid width for the branding (logo) area and navigation menus.'),
        );
        $form['chicago_2011_container']['chicago_2011_regions']['headers']['chicago_2011_header_logo_width'] = array(
          '#type' => 'select',
          '#title' => t('Width for Logo/Branding area'),
          '#default_value' => $saved_settings['chicago_2011_header_logo_width'],
          '#options' => $grids,
        ...
        $form['chicago_2011_container']['chicago_2011_regions']['headers']['chicago_2011_header_menu_width'] = array(
          '#type' => 'select',
          '#title' => t('Wrapper Area width for Menu Elements'),
          '#default_value' => $saved_settings['chicago_2011_header_menu_width'],
          '#options' => $grids,
        ...
        $form['chicago_2011_container']['chicago_2011_regions']['headers']['chicago_2011_header_wrapper_width'] = array(
          '#type' => 'select',
          '#title' => t('Wrapper Area width for Header Elements'),
          '#default_value' => $saved_settings['chicago_2011_header_wrapper_width'],
          '#options' => $containers,
          '#description' => t('Container Grid width for the header region areas.'),
        );
        $form['chicago_2011_container']['chicago_2011_regions']['headers']['chicago_2011_header_first_width'] = array(
          '#type' => 'select',
          '#title' => t('Contextual Width for Header First'),
          '#default_value' => $saved_settings['chicago_2011_header_first_width'],
          '#options' => $grids,
          '#description' => t('Grid width of the first header region. This number should be less than or equal to the container width defined above.'),
        );
        $form['chicago_2011_container']['chicago_2011_regions']['headers']['chicago_2011_header_last_width'] = array(
          '#type' => 'select',
          '#title' => t('Contextual Width for Header Last'),
          '#default_value' => $saved_settings['chicago_2011_header_last_width'],
          '#options' => $grids,
          '#description' => t('Grid width of the last header region. This number should be less than or equal to the container width defined above.'),
        );
        $form['chicago_2011_container']['chicago_2011_regions']['headers']['chicago_2011_internal_nav_wrapper_width'] = array(
          '#type' => 'select',
          '#title' => t('Wrapper Area width for Breadcrumb/Slogan/Search'),
          '#default_value' => $saved_settings['chicago_2011_internal_nav_wrapper_width'],
          '#options' => $containers,
          '#description' => t('Container Grid width for the breadcrumb/search/slogan area.'),
        );
        $form['chicago_2011_container']['chicago_2011_regions']['headers']['chicago_2011_breadcrumb_slogan_width'] = array(
          '#type' => 'select',
          '#title' => t('Wrapper Area width for Breadcrumb/Slogan'),
          '#default_value' => $saved_settings['chicago_2011_breadcrumb_slogan_width'],
          '#options' => $grids,
        ...
        $form['chicago_2011_container']['chicago_2011_regions']['headers']['chicago_2011_search_width'] = array(
          '#type' => 'select',
          '#title' => t('Wrapper Area width for Search'),
          '#default_value' => $saved_settings['chicago_2011_search_width'],
          '#options' => $grids,
          '#description' => t('Grid width for the search zone, which appears inline with the breadcrumb/slogan zone.'),
        );

      // Preface Blocks
      $form['chicago_2011_container']['chicago_2011_regions']['preface'] = array(
        '#type' => 'fieldset',
        ...
        $form['chicago_2011_container']['chicago_2011_regions']['preface']['chicago_2011_preface_wrapper_grids'] = array(
          '#type' => 'select',
          '#title' => t('Preface Wrapper Container Grids'),
          '#default_value' => $saved_settings['chicago_2011_preface_wrapper_grids'],
          '#options' => $containers,
          '#description' => t('Container Grid width for the preface regions.'),
        );
        $form['chicago_2011_container']['chicago_2011_regions']['preface']['chicago_2011_preface_first_width'] = array(
          '#type' => 'select',
          '#title' => t('Contextual Width for Preface First'),
          '#default_value' => $saved_settings['chicago_2011_preface_first_width'],
          '#options' => $grids,
        ...
        $form['chicago_2011_container']['chicago_2011_regions']['preface']['chicago_2011_preface_first_prefix'] = array(
          '#type' => 'select',
          '#title' => t('Prefix Spacing for Preface First'),
          '#default_value' => $saved_settings['chicago_2011_preface_first_prefix'],
          '#options' => $spacing,
         ...
         $form['chicago_2011_container']['chicago_2011_regions']['preface']['chicago_2011_preface_first_suffix'] = array(
          '#type' => 'select',
          '#title' => t('Suffix Spacing for Preface First'),
          '#default_value' => $saved_settings['chicago_2011_preface_first_suffix'],
          '#options' => $spacing,
        ...
        $form['chicago_2011_container']['chicago_2011_regions']['preface']['chicago_2011_preface_middle_width'] = array(
          '#type' => 'select',
          '#title' => t('Contextual Width for Preface Middle'),
          '#default_value' => $saved_settings['chicago_2011_preface_middle_width'],
          '#options' => $grids,
        ...
        $form['chicago_2011_container']['chicago_2011_regions']['preface']['chicago_2011_preface_middle_prefix'] = array(
          '#type' => 'select',
          '#title' => t('Prefix Spacing for Preface Middle'),
          '#default_value' => $saved_settings['chicago_2011_preface_middle_prefix'],
          '#options' => $spacing,
          '#prefix' => '<div class="prefix_config">',
          '#suffix' => '</div>',
          '#description' => t('Adding prefix grids to this element will add padding to the left side of the element, creating spacing between the previous element.'),
        );
         $form['chicago_2011_container']['chicago_2011_regions']['preface']['chicago_2011_preface_middle_suffix'] = array(
          '#type' => 'select',
          '#title' => t('Suffix Spacing for Preface Middle'),
          '#default_value' => $saved_settings['chicago_2011_preface_middle_suffix'],
          '#options' => $spacing,
          '#prefix' => '<div class="suffix_config">',
          '#suffix' => '</div>',
          '#description' => t('Adding suffix grids to this element will add padding to the right side of the element, creating spacing between the next element.'),
        );
        $form['chicago_2011_container']['chicago_2011_regions']['preface']['chicago_2011_preface_last_width'] = array(
          '#type' => 'select',
          '#title' => t('Contextual Width for Preface Last'),
          '#default_value' => $saved_settings['chicago_2011_preface_last_width'],
          '#options' => $grids,
        ...
        $form['chicago_2011_container']['chicago_2011_regions']['preface']['chicago_2011_preface_last_prefix'] = array(
          '#type' => 'select',
          '#title' => t('Prefix Spacing for Preface Last'),
          '#default_value' => $saved_settings['chicago_2011_preface_last_prefix'],
          '#options' => $spacing,
          '#prefix' => '<div class="prefix_config">',
          '#suffix' => '</div>',
          '#description' => t('Adding prefix grids to this element will add padding to the left side of the element, creating spacing between the previous element.'),
        );
         $form['chicago_2011_container']['chicago_2011_regions']['preface']['chicago_2011_preface_last_suffix'] = array(
          '#type' => 'select',
          '#title' => t('Suffix Spacing for Preface Last'),
          '#default_value' => $saved_settings['chicago_2011_preface_last_suffix'],
          '#options' => $spacing,
          '#prefix' => '<div class="suffix_config">',
          '#suffix' => '</div>',
          '#description' => t('Adding suffix grids to this element will add padding to the right side of the element, creating spacing between the next element.'),
      ...
      // Main Body Regions
      $form['chicago_2011_container']['chicago_2011_regions']['main'] = array(
        '#type' => 'fieldset',
        ...
        $form['chicago_2011_container']['chicago_2011_regions']['main']['chicago_2011_content_layout'] = array(
          '#type'          => 'radios',
          '#description'   => t('You may arrange the order and size of your sidebars and main content zones here.'),
          '#title'         => t('Content Zone Layout'),
          '#default_value' => $saved_settings['chicago_2011_content_layout'],
          '#options'       => array(
        ...
        $form['chicago_2011_container']['chicago_2011_regions']['main']['chicago_2011_content_container_width'] = array(
          '#type' => 'select',
          '#title' => t('Container width for content zone'),
          '#default_value' => $saved_settings['chicago_2011_content_container_width'],
          '#options' => $containers,
        ...
        $form['chicago_2011_container']['chicago_2011_regions']['main']['chicago_2011_sidebar_first_width'] = array(
          '#type' => 'select',
          '#title' => t('Contextual Width for Sidebar First'),
          '#default_value' => $saved_settings['chicago_2011_sidebar_first_width'],
          '#options' => $grids,
        ...
        $form['chicago_2011_container']['chicago_2011_regions']['main']['chicago_2011_content_main_width'] = array(
          '#type' => 'select',
          '#title' => t('Contextual Width for Main Content Region'),
          '#default_value' => $saved_settings['chicago_2011_content_main_width'],
          '#options' => $grids,
        ...
        $form['chicago_2011_container']['chicago_2011_regions']['main']['chicago_2011_sidebar_last_width'] = array(
          '#type' => 'select',
          '#title' => t('Contextual Width for Sidebar Last'),
          '#default_value' => $saved_settings['chicago_2011_sidebar_last_width'],
          '#options' => $grids,
        ...
        $form['chicago_2011_container']['chicago_2011_regions']['main']['sidebar_contain_pages'] = array(
          '#type' => 'textarea',
          '#title' => t('Pages'),
      ...
      // Postscript Blocks
      $form['chicago_2011_container']['chicago_2011_regions']['postscript'] = array(
        '#type' => 'fieldset',
        ...
        $form['chicago_2011_container']['chicago_2011_regions']['postscript']['chicago_2011_postscript_container_width'] = array(
          '#type' => 'select',
        ...
        $form['chicago_2011_container']['chicago_2011_regions']['postscript']['chicago_2011_postscript_one_width'] = array(
          ...
          '#default_value' => $saved_settings['chicago_2011_postscript_one_width'],
          '#options' => $grids,
          '#description' => t('Grid width of the first postscript region. This number should be less than or equal to the container width defined above.'),
        );
        $form['chicago_2011_container']['chicago_2011_regions']['postscript']['chicago_2011_postscript_one_prefix'] = array(
          '#type' => 'select',
          '#title' => t('Prefix Spacing for Postscript 1'),
          '#default_value' => $saved_settings['chicago_2011_postscript_one_prefix'],
          '#options' => $spacing,
          '#prefix' => '<div class="prefix_config">',
          '#suffix' => '</div>',
          '#description' => t('Adding prefix grids to this element will add padding to the left side of the element, creating spacing between the previous element.'),
        );
         $form['chicago_2011_container']['chicago_2011_regions']['postscript']['chicago_2011_postscript_one_suffix'] = array(
          '#type' => 'select',
          '#title' => t('Suffix Spacing for Postscript 1'),
          '#default_value' => $saved_settings['chicago_2011_postscript_one_suffix'],
          '#options' => $spacing,
          '#prefix' => '<div class="suffix_config">',
          '#suffix' => '</div>',
          '#description' => t('Adding suffix grids to this element will add padding to the right side of the element, creating spacing between the next element.'),
        );
        $form['chicago_2011_container']['chicago_2011_regions']['postscript']['chicago_2011_postscript_two_width'] = array(
          '#type' => 'select',
          '#title' => t('Contextual Width for Postscript 2'),
          '#default_value' => $saved_settings['chicago_2011_postscript_two_width'],
          '#options' => $grids,
        ...
        $form['chicago_2011_container']['chicago_2011_regions']['postscript']['chicago_2011_postscript_two_prefix'] = array(
          '#type' => 'select',
          '#title' => t('Prefix Spacing for Postscript 2'),
          '#default_value' => $saved_settings['chicago_2011_postscript_two_prefix'],
          '#options' => $spacing,
          '#prefix' => '<div class="prefix_config">',
          '#suffix' => '</div>',
          '#description' => t('Adding prefix grids to this element will add padding to the left side of the element, creating spacing between the previous element.'),
        );
         $form['chicago_2011_container']['chicago_2011_regions']['postscript']['chicago_2011_postscript_two_suffix'] = array(
          '#type' => 'select',
          '#title' => t('Suffix Spacing for Postscript 2'),
          '#default_value' => $saved_settings['chicago_2011_postscript_two_suffix'],
          '#options' => $spacing,
          '#prefix' => '<div class="suffix_config">',
          '#suffix' => '</div>',
          '#description' => t('Adding suffix grids to this element will add padding to the right side of the element, creating spacing between the next element.'),
        );
        $form['chicago_2011_container']['chicago_2011_regions']['postscript']['chicago_2011_postscript_three_width'] = array(
          '#type' => 'select',
          '#title' => t('Contextual Width for Postscript 3'),
          '#default_value' => $saved_settings['chicago_2011_postscript_three_width'],
          '#options' => $grids,
        ...
        $form['chicago_2011_container']['chicago_2011_regions']['postscript']['chicago_2011_postscript_three_prefix'] = array(
          '#type' => 'select',
          '#title' => t('Prefix Spacing for Postscript 3'),
          '#default_value' => $saved_settings['chicago_2011_postscript_three_prefix'],
          '#options' => $spacing,
          '#prefix' => '<div class="prefix_config">',
          '#suffix' => '</div>',
          '#description' => t('Adding prefix grids to this element will add padding to the left side of the element, creating spacing between the previous element.'),
        );
         $form['chicago_2011_container']['chicago_2011_regions']['postscript']['chicago_2011_postscript_three_suffix'] = array(
          '#type' => 'select',
          '#title' => t('Suffix Spacing for Postscript 3'),
          '#default_value' => $saved_settings['chicago_2011_postscript_three_suffix'],
          '#options' => $spacing,
          '#prefix' => '<div class="suffix_config">',
          '#suffix' => '</div>',
          '#description' => t('Adding suffix grids to this element will add padding to the right side of the element, creating spacing between the next element.'),
        );
        $form['chicago_2011_container']['chicago_2011_regions']['postscript']['chicago_2011_postscript_four_width'] = array(
          '#type' => 'select',
          '#title' => t('Contextual Width for Postscript 4'),
          '#default_value' => $saved_settings['chicago_2011_postscript_four_width'],
          '#options' => $grids,
        ...
        $form['chicago_2011_container']['chicago_2011_regions']['postscript']['chicago_2011_postscript_four_prefix'] = array(
          '#type' => 'select',
          '#title' => t('Prefix Spacing for Postscript 4'),
          '#default_value' => $saved_settings['chicago_2011_postscript_four_prefix'],
          '#options' => $spacing,
          '#prefix' => '<div class="prefix_config">',
          '#suffix' => '</div>',
          '#description' => t('Adding prefix grids to this element will add padding to the left side of the element, creating spacing between the previous element.'),
        );
         $form['chicago_2011_container']['chicago_2011_regions']['postscript']['chicago_2011_postscript_four_suffix'] = array(
          '#type' => 'select',
          '#title' => t('Suffix Spacing for Postscript 4'),
          '#default_value' => $saved_settings['chicago_2011_postscript_four_suffix'],
          '#options' => $spacing,
          '#prefix' => '<div class="suffix_config">',
          '#suffix' => '</div>',
          '#description' => t('Adding suffix grids to this element will add padding to the right side of the element, creating spacing between the next element.'),
      ...
      // Footer Blocks
      $form['chicago_2011_container']['chicago_2011_regions']['footer'] = array(
        '#type' => 'fieldset',
        ...
        $form['chicago_2011_container']['chicago_2011_regions']['footer']['chicago_2011_footer_container_width'] = array(
          '#type' => 'select',
          '#title' => t('Container width for footer regions'),
          '#default_value' => $saved_settings['chicago_2011_footer_container_width'],
          '#options' => $containers,
          '#description' => t('Container Grid width for the footer regions.'),
        );
        $form['chicago_2011_container']['chicago_2011_regions']['footer']['chicago_2011_footer_first_width'] = array(
          '#type' => 'select',
          '#title' => t('Contextual Width for Footer First'),
          '#default_value' => $saved_settings['chicago_2011_footer_first_width'],
          '#options' => $grids,
        ...
        $form['chicago_2011_container']['chicago_2011_regions']['footer']['chicago_2011_footer_last_width'] = array(
          '#type' => 'select',
          '#title' => t('Contextual Width for Footer Last'),
          '#default_value' => $saved_settings['chicago_2011_footer_last_width'],
          '#options' => $grids,
