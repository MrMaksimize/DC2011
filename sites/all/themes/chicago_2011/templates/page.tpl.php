...
<body class="<?php print $body_classes; ?>">
  ...
  <div id="page-inner-wrapper">
  	...
  	<?php if ($user_bar_first || $user_bar_last): ?>
      <div id="user-bar-zone-wrapper" class="zone-wrapper user-bar-zone-wrapper">
        <div id="user-bar-regions" class="container-<?php print $user_bar_wrapper_width; ?> clearfix">
          <?php if($user_bar_first): ?>
            <div id="user-bar-first" class="<?php print $user_bar_first_classes; ?>">
              <?php print $user_bar_first; ?>
            </div><!-- /#user-bar-first -->
          <?php endif; ?>
          <?php if($user_bar_last): ?>
            <div id="user-bar-last" class="<?php print $user_bar_last_classes; ?>">
              <?php print $user_bar_last; ?>
            </div><!-- /#user-bar-last -->
          <?php endif; ?>
        </div><!-- /#user-bar -->
      </div><!-- /#user-bar-zone-wrapper -->
    <?php endif; ?>
    
    <div id="header-zone-wrapper" class="zone-wrapper header-zone-wrapper">
    ...
    <div id="preface-zone-wrapper" class="zone-wrapper preface-zone-wrapper">
    ...
    <div id="main-zone-wrapper" class="zone-wrapper main-zone-wrapper">
    ...
    </div><!-- /#postscript-zone-wrapper -->
    <?php endif; ?>
    
    <?php if($footer_first || $footer_last || $footer_message): ?>
    <div id="footer-zone-wrapper" class="zone-wrapper footer-zone-wrapper">
