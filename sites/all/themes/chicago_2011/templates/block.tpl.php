...
<div id="block-<?php print $block->module .'-'. $block->delta; ?>" class="block block-<?php print $block->module ?> <?php print $skinr; ?> <?php if ($block->bid == 'block-1'): ?> <?php print $skinr_welcome_message ?> <?php endif; ?>">
